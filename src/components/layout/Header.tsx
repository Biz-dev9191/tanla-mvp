        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                type="button"
                className="flex items-center text-left bg-transparent border-0 p-0 cursor-pointer focus:outline-none"
                onClick={() => {
                  if (typeof window !== 'undefined') {
                    try {
                      sessionStorage.removeItem('aurora_session_brief_state');
                      sessionStorage.removeItem('aurora_custom_rules');
                      sessionStorage.removeItem('aurora_custom_policy_doc');
                      sessionStorage.removeItem('aurora_custom_policy_tree');
                    } catch (e) {}
        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="fixed inset-y-0 left-0 max-w-full flex pr-10">
            <div className="w-screen max-w-md bg-aurora-neutral-0 border-r border-aurora-neutral-200 shadow-2xl flex flex-col justify-between transform transition-transform ease-in-out duration-300">
              ...
              {/* Drawer Header */}
              <div className="px-5 py-4 border-b border-aurora-neutral-200 flex items-center justify-between bg-aurora-neutral-100/50">
                <div>
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                <div>
                  <span className="text-[11px] font-bold uppercase tracking-wider text-aurora-neutral-500 block mb-2.5">
                    System Views
                  </span>
              ...
              {/* Settings & Data Section - Compact & Positioned Only at Bottom */}
              <div className="mt-auto px-5 py-3 border-t border-aurora-neutral-200 bg-aurora-neutral-50/90">
                <span className="text-[10px] font-bold uppercase tracking-wider text-aurora-neutral-500 block mb-1.5">
                  Settings & Data
                </span>
                {onClearHistory && (
                  <button
                    ...
                    className="w-full flex items-center space-x-2 px-3 py-2 rounded-lg bg-white hover:bg-red-50 text-aurora-neutral-700 hover:text-red-700 border border-aurora-neutral-200 hover:border-red-200 text-xs font-semibold shadow-2xs transition group cursor-pointer"
                  >
                    <Trash2 strokeWidth={1.5} className="w-3.5 h-3.5 text-aurora-neutral-400 group-hover:text-red-600 transition flex-shrink-0" />
                    <span>Delete Audit History</span>
                  </button>
                )}
                <div className="text-[10px] text-aurora-neutral-400 text-center mt-2 font-medium">
